...
**TAC Reminder:** This review follows TAC Principle 4 (Closed-Loop Validation):
1. **Use Validation Checklist:** Reference `.claude/validation-checklists/[type]-validation.md`
2. **Spec Compliance:** All spec requirements must be met
3. **Automated Tests:** Run validation commands from spec
4. **Definition of Done:** Check all criteria before approval
...
- **TAC Step:** Identify issue type (feature/bug/chore) and load appropriate validation checklist from `.claude/validation-checklists/`
...
- **TAC Step:** Verify spec's "Definition of Done" section is complete
