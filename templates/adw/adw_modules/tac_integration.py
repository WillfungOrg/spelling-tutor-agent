...
class TACIntegration:
    ...
    def identify_knowledge_gaps(self, issue_data: IssueData) -> List[KnowledgeGap]:
        ...
        project_context_path = self.claude_dir / "project-context.md"
        if not project_context_path.exists():
            gaps.append(KnowledgeGap(
                category="project",
                description="Project context file missing",
                impact="critical",
                how_to_fill="Create .claude/project-context.md with project details",
                required=True
            ))
    ...
    def load_project_context(self) -> Optional[Dict]:
        ...
        """
        context_path = self.claude_dir / "project-context.md"
