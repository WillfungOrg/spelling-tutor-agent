...
SlashCommand = Literal[
    ...
    "/bug",
    "/feature",
    # Meta-ADW strategy commands
    "/strategy/interview",
    "/strategy/analyze",
    "/strategy/recommend",
    "/strategy/validate_plan",
...
class ADWStateData(BaseModel):
    ...
    # Meta-ADW tracking fields (optional, only set if Meta-ADW was used)
    recommended_strategy: Optional[str] = None  # Recommended workflow name
    strategy_confidence: Optional[float] = None  # Confidence score (0-1)
    meta_adw_used: Optional[bool] = False  # Whether Meta-ADW was used
