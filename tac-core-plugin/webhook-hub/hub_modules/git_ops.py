...
from hub_modules.github import get_repo_url, extract_repo_path, make_issue_comment
    ...
    if pr_url:
        ...
        if issue_number:
            try:
                repo_url = get_repo_url()
                repo_path = extract_repo_path(repo_url)
                from hub_modules.github import fetch_issue

                issue = fetch_issue(issue_number, repo_path)

                from hub_modules.workflow_ops import create_pull_request
