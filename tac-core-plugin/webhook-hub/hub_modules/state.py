...
from hub_modules.data_types import ADWStateData
...
class ADWState:
    ...
    def update(self, **kwargs):
        ...
        # Filter to only our core fields (including Meta-ADW fields)
        core_fields = {
            "adw_id", "issue_number", "branch_name", "plan_file", "issue_class",
            "worktree_path", "backend_port", "frontend_port", "model_set", "all_adws",
            # Meta-ADW tracking fields
            "recommended_strategy", "strategy_confidence", "meta_adw_used"
        }
