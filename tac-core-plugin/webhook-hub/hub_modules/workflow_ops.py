...
from hub_modules.data_types import (
...
from hub_modules.agent import execute_template, execute_template_async
from hub_modules.github import get_repo_url, extract_repo_path, ADW_BOT_IDENTIFIER
from hub_modules.state import ADWState
from hub_modules.utils import parse_json
from hub_modules.worktree_ops import get_default_branch
...
async def extract_adw_info_async(text: str, temp_adw_id: str) -> ADWExtractionResult:
    ...
    try:
        response = await execute_template_async(request)  # Await async version
...
def ensure_plan_exists(state: ADWState, issue_number: str) -> str:
    ...
    from hub_modules.git_ops import get_current_branch
...
def create_or_find_branch(
    ...
    # Create the branch
    from hub_modules.git_ops import create_branch
