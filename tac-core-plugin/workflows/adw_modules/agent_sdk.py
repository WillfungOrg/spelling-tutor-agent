...
def load_and_expand_slash_command(slash_command: str, args: List[str], working_dir: str) -> str:
    ...
    Args:
        ...
        working_dir: Working directory where .claude/commands/ exists
    ...
    # Load template from .claude/commands/
    template_path = os.path.join(working_dir, ".claude", "commands", f"{command_name}.md")
