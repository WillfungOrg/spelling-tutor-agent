...
CRITICAL: Return ONLY the branch name itself - nothing else!
- NO explanations
- NO markdown formatting
- NO code blocks
- NO additional text
- JUST the branch name on a single line

Example correct output: `chore-issue-789-adw-i9j0k1l2-update-dependencies`
Example WRONG output: "Based on the issue, the branch name is: chore-..." (DO NOT DO THIS!)