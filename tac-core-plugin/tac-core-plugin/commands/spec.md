...
Let me check:
1. Project context: [Read CLAUDE.md "Project-Specific Context" section]
2. Framework versions: [From CLAUDE.md]
...
- **Project Context:** `CLAUDE.md "Project-Specific Context" section` - Project info
