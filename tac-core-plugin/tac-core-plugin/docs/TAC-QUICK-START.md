...
**File:** `CLAUDE.md "Project-Specific Context" section`
...
### Must Have
- `CLAUDE.md "Project-Specific Context" section` - Your project details
...
### Before ANY Work
```
✓ Read CLAUDE.md "Project-Specific Context" section
...
2. **Set Up CLAUDE.md** (15 min)
   ```bash
   cp templates/project-context\ template.md CLAUDE.md "Project-Specific Context" section
